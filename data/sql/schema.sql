...
CREATE TABLE crafting_recipe (id BIGINT AUTO_INCREMENT, name text NOT NULL, inputs LONGTEXT, outputs LONGTEXT, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
...
CREATE TABLE proxy (id BIGINT AUTO_INCREMENT, type text, params LONGTEXT, timestamp BIGINT, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
