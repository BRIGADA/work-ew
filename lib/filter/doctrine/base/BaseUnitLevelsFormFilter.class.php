...
/**
 * UnitLevels filter form base class.
 *
 * @package    edgeworld
 * @subpackage filter
 * @author     BRIGADA
 ...
 */
abstract class BaseUnitLevelsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('unit_levels_filters[%s]');
