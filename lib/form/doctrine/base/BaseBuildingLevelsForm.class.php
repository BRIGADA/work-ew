...
/**
 * BuildingLevels form base class.
 *
 * @method BuildingLevels getObject() Returns the current form's model object
 *
 * @package    edgeworld
 * @subpackage form
 * @author     BRIGADA
 ...
 */
abstract class BaseBuildingLevelsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('building_levels[%s]');
