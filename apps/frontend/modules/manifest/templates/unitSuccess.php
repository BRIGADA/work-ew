...
<div class="page-header clearfix">
  <img class="pull-right" alt="<?php echo $unit->type ?>" style="max-height: 120px" src="<?php printf('https://kabam1-a.akamaihd.net/edgeworld/images/units/%s.png', strtolower($unit->type)) ?>">
  <h1><?php echo __(strtolower($unit->type . '.name'), array(), 'ew-units') ?></h1>
  <p class="lead"><?php echo __EW('units', $unit->type, 'description') ?></p>
</div>
