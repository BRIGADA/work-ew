...
<p>
  <a href="#clientform" data-toggle="modal" class="btn btn-default">Изменить</a>
  <a href="#parseurlform" data-toggle="modal" class="btn btn-default">URL</a>
</p>

<form action="<?php echo url_for('common/setClient') ?>" method="post" class="modal fade" id="clientform">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">Изменение параметров клиента</h4>
      </div>
      <div class="modal-body">
        <?php echo $clientForm->renderUsing('bootstrapDefault') ?>
      </div>
